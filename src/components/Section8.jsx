                ...
                >
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            ...
                            >
                                {box1Visible && (
                                    <AnimatedNumber number={20} delay={500} />
                                )}
                                X{" "}
                                <ArrowUpward
                                    sx={{
                            ...
                            >
                                Faster at Identifying and Investing in New
                                Technologies
                            </Typography>
                            <Typography
                                variant="body1"
                            ...
                            >
                                Helps you identify and acquire high-potential,
                                emerging technologies 20x faster than
                                competitors. Never miss game-changing
                                innovations again.
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            ...
                            >
                                {box2Visible && (
                                    <AnimatedNumber number={40} delay={0} />
                                )}
                                %{" "}
                                <ArrowUpward
                                    sx={{
                            ...
                            >
                                Tech scouts are 40% more likely to discover
                                unique, hidden technologies not found elsewhere.
                                Our emphasis on connections to innovators
                                ensures access to breakthroughs that remain
                                undiscovered.
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            ...
                            >
                                {box3Visible && (
                                    <AnimatedNumber number={18} delay={1000} />
                                )}{" "}
                                <span
                                    style={{
                                        fontFamily: "Manrope",
                            ...
                            >
                                Get an 18-month head start on competitors by
                                leveraging Immortal's ability to pinpoint
                                disruptive tech opportunities before mainstream
                                adoption.
                            </Typography>
                        </Box>
                    </Grid>
