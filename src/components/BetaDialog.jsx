                ...
                {isSubmitted ? (
                    ...
                    >
                        ...
                        >
                            ...
                            shortly to invite you to participate in our beta
                            testing program. We're excited to have you try out
                            our innovative AI platform and look forward to your
                            valuable feedback.
                        </Typography>
                    </Box>
                ) : (
                        ...
                        >
                            ...
                            <Box sx={{ width: "100%", textAlign: "left" }}>
                                ...
                                >
                                    {isMobile ? (
                                        <>
                                            Join our Beta Invest in Next-Gen
                                            Tech Today
                                        </>
                                    ) : (
                                        <>
                                            Join our Beta <br /> Invest in
                                            Next-Gen <br /> Tech Today
                                        </>
                                    )}
                                </Typography>
                                <Box
                                ...
                                >
                                    ...
                                    >
                                        <strong style={{ color: "#096B5F" }}>
                                            20X
                                        </strong>{" "}
                                        Faster at Identifying and Investing in
                                        New Technologies
                                    </Typography>
                                </Box>
                                <Box
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        Lead in Forecasting Technological
                                        Developments
                                    </Typography>
                                </Box>
                            </Box>
                                                    ...
                                                    "& .MuiOutlinedInput-root":
                                                        {
                                                            "&.Mui-focused fieldset":
                                                                {
                                                                    borderColor:
                                                                        "#0EA996", // Change border color on focus
                                                                },
                                                        },
                                                    "& .MuiInputBase-root": {
                                                        height: "52px",
